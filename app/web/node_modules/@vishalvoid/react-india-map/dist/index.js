...
const IndiaMap = ({ mapStyle = {
...
}, stateData = [], onStateHover, onStateClick, }) => {
    var _a;
    ...
    const originalColors = React.useRef(new Map());
    const mapContainerRef = React.useRef(null);
    React.useEffect(() => {
        const loadSVG = () => __awaiter(void 0, void 0, void 0, function* () {
            const content = yield fetchSVGContent();
            if (content)
    ...
    React.useEffect(() => {
        if (svgContent && mapContainerRef.current) {
            ...
            setTimeout(() => {
                var _a;
                const paths = (_a = mapContainerRef.current) === null || _a === void 0 ? void 0 : _a.querySelectorAll("path");
                if (paths) {
                    paths.forEach((path) => {
    ...
    const currentStateData = hoverInfo
        ? stateData.find((state) => state.id === hoverInfo.id)
        : undefined;
    // Function to determine tooltip display
    const shouldDisplayTooltip = () => {
        return showTooltip && hoverInfo && (currentStateData === null || currentStateData === void 0 ? void 0 : currentStateData.customData);
    };
    // Get tooltip styles
    const getTooltipStyles = () => {
        ...
        return {
            ...
            backgroundColor: ((_a = mapStyle.tooltipConfig) === null || _a === void 0 ? void 0 : _a.backgroundColor) || "rgba(0, 0, 0, 0.8)",
            color: ((_b = mapStyle.tooltipConfig) === null || _b === void 0 ? void 0 : _b.textColor) || "#ffffff",
            padding: "8px 12px",
            borderRadius: "4px",
            fontSize: "14px",
            zIndex: 1000,
    ...
    return (React.createElement("div", { className: "india-map-container", onMouseMove: handleMouseMove, style: { position: "relative", width: "100%" } },
        shouldDisplayTooltip() && (React.createElement("div", { className: "state-tooltip", style: getTooltipStyles() },
            React.createElement("div", { style: getTooltipHeaderStyles() }, (hoverInfo === null || hoverInfo === void 0 ? void 0 : hoverInfo.title) || ((_a = currentStateData === null || currentStateData === void 0 ? void 0 : currentStateData.customData) === null || _a === void 0 ? void 0 : _a.name) || (hoverInfo === null || hoverInfo === void 0 ? void 0 : hoverInfo.id)),
            (currentStateData === null || currentStateData === void 0 ? void 0 : currentStateData.customData) && (React.createElement("div", null, Object.entries(currentStateData.customData).map(([key, value]) => key !== "name" && (React.createElement("div", { key: key, style: getTooltipRowStyles() },
                React.createElement("span", { style: { fontWeight: "bold", textTransform: "capitalize" } },
                    key,
                    ":"),
                React.createElement("span", null, String(value))))))))),
        React.createElement("div", { ref: mapContainerRef, dangerouslySetInnerHTML: { __html: svgContent }, style: { width: "100%", height: "100%" }, onMouseOver: (e) => {
                const path = e.target;
...
exports.INDIA_SVG_MAP = INDIA_SVG_MAP;
